...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li><a href="alarm.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Alarm</a></li>
    ...
    <div class="modal-dialog" style="width:400px;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><?php include "addclient2.php"; ?></p>
        </div>
...
var info = 'id=' + del_id;
 ...
 $.ajax({
   ...
   success: function(){
         ...
         $(this).parents(".record").animate({ backgroundColor: "lightblue" }, "fast")
