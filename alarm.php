...
<div class="container">
<div id="wrapper">
  <h1><center><b>Water Management System</b></center></h1>
  ...
  <ul class="nav nav-pills">
    ...
    <li><a href="clients.php"><span class="glyphicon glyphicon-user"></span>&nbsp;Clients</a></li>
    <li class="btn btn-default btn-xs"><a href="alarm.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Alarm</a></li>
    <li><a href="map.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Map</a></li>
  </ul>
<hr color="#999999" />
    ...
    <div class="modal-dialog" style="width:400px;">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Water Management System</h4>
        </div>
  ...
  <!-------------------------- modal ends ---------------------------->
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5>System Notification</h5>
                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal"> Tap ON</button>
